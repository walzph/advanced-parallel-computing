...
int main(int argc, char* argv[])
{
	...
	for(uint batch = 0; batch < num_batches; ++batch)
	{
		...
		batch_normalization_arm<batch_size, num_neurons>((float32_t*) out_tensor_0_t.get(), (float32_t*) beta_0, (float32_t*) mean_0, (float32_t*) zeta_0.get());
		...
		batch_normalization_arm<batch_size, num_neurons>((float32_t*) out_tensor_1_t.get(), (float32_t*) beta_1, (float32_t*) mean_1, (float32_t*) zeta_1.get());		
		...
		batch_normalization_arm<batch_size, num_neurons>((float32_t*) out_tensor_2_t.get(), (float32_t*) beta_2, (float32_t*) mean_2, (float32_t*) zeta_2.get());
